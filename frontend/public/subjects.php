...
<head>
    ...
    <title>Subject Management - International School Portal</title>
    <style>
        :root {
                ...
                <?php if (!empty($subjects)): ?>
                    <?php foreach ($subjects as $subject): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_subject.php?id=<?php echo $subject['id']; ?>" class="btn btn-sm btn-edit">Edit</a>
                                <a href="delete_subject.php?id=<?php echo $subject['id']; ?>" class="btn btn-sm btn-delete" onclick="return confirm('Are you sure you want to delete this subject?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
