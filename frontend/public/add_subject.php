...
<head>
    ...
    <title>Add New Subject - International School Portal</title>
    <style>
        :root {
            /* Light Mode */
        ...
        .form-group input, .form-group textarea { width: 100%; padding: 10px; border-radius: 4px; border: 1px solid var(--input-border, var(--input-border-light)); background-color: var(--input-bg, var(--input-bg-light)); color: var(--text-color, var(--text-color-light)); box-sizing: border-box; }
...
<body>
    ...
    <div class="container">
        ...
        <form action="../../backend/actions/add_subject.php" method="POST">
