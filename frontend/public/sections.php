...
<head>
    ...
    <title>Section Management - International School Portal</title>
    <style>
        :root {
...
<body>
    ...
    <div class="container">
        <div class="action-bar">
            <a href="add_section.php" class="btn">Add New Section</a>
        </div>
                ...
                <?php if (!empty($sections)): ?>
                    <?php foreach ($sections as $section): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_section.php?id=<?php echo $section['id']; ?>" class="btn btn-sm btn-edit">Edit</a>
                                <a href="delete_section.php?id=<?php echo $section['id']; ?>" class="btn btn-sm btn-delete" onclick="return confirm('Are you sure you want to delete this section?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
