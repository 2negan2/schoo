...
<head>
    ...
    <title>Add New Attendance Record - International School Portal</title>
    <style>
        :root {
            /* Light Mode */
        ...
        .form-group input[type="date"], .form-group select { width: 100%; padding: 10px; border-radius: 4px; border: 1px solid var(--input-border, var(--input-border-light)); background-color: var(--input-bg, var(--input-bg-light)); color: var(--text-color, var(--text-color-light)); box-sizing: border-box; }
        .form-group .radio-group { display: flex; gap: 20px; margin-top: 10px; }
        .form-group .radio-group label { display: inline-flex; align-items: center; font-weight: normal; }
        .form-group .radio-group input[type="radio"] { width: auto; margin-right: 5px; }
...
<body>
    ...
    <div class="container">
        ...
        <form action="../../backend/actions/add_attendance.php" method="POST">
