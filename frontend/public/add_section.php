...
?>
    ...
    <div class="container <?php echo $container_class; ?>">
        ...
        <form action="/programing/schoo-main/schoo-main/schoo/backend/actions/add_section.php" method="POST">
            ...
            <a href="/programing/schoo-main/schoo-main/schoo/frontend/public/sections.php" class="btn btn-secondary"><i class="fas fa-times"></i> Cancel</a>
        </form>
    </div>
