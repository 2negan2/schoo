                ...
                <?php if (!empty($teachers)): ?>
                    <?php foreach ($teachers as $teacher): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_teacher.php?id=<?php echo $teacher['id']; ?>" class="btn btn-sm btn-edit">Edit</a>
                                <a href="delete_teacher.php?id=<?php echo $teacher['id']; ?>" class="btn btn-sm btn-delete" onclick="return confirm('Are you sure you want to delete this teacher?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
